...
## Storytelling
With this model, I believe I have reached the intial goal of this project. With the decision trees, we can see the main factors that play in to habitability. Additionally, if a new planet is discovered, we can use the decision trees to predict wether it will be habitable. To demonstrate this, I found a planet that was discovered this year, is not in my dataset, and as far as I can tell, does not yet have a habitability prediction on any sites. This planet is Wolf 237b.  The planet has an estimate surface temperature of 996 Kelvin. Following either of my decision trees, because the root node is based on surface temperature, I can go ahead and predict that this planet will be uninhabitable. All 2700 planets with surface tempature greater than around ~326 Kelvin were predicted to be uninhabiable.
